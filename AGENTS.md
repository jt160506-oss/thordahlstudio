...
- **Priser står på sitet (besluttet 22. aug. 2026 — erstatter den tidligere regel om ingen priser).** Prislisten er Enkel 6.500 / Udvidet 9.500 / Med værktøj fra 14.500 kr., alle ekskl. moms, halvdelen ved opstart og halvdelen ved levering. Den gamle regel kom af "fra 749 kr.", som lå så langt under markedet, at den modsagde "håndkodet, ingen skabeloner". Et *lokkebeløb* er stadig forbudt; en **fuld, ærlig prisliste** er ikke det samme, og den er nu en del af løftet ("Priser står på siden"). Sæt ikke priserne ned uden Jakobs udtrykkelige beslutning — bekræftet 15. sept. 2026, hvor et forslag om 2.995/5.495/7.249 blev fravalgt, fordi 0 henvendelser skyldes manglende synlighed, ikke prisen. **Introtilbuddet er 2.995 kr. for de første tre projekter, dog længst til 31. dec. 2026**, mod case-rettigheder og en skriftlig udtalelse. Det er en tidsbegrænset case-rabat, ikke prislisten — forveksl ikke de to, og lad ikke tilbuddet erstatte de rigtige tal.
